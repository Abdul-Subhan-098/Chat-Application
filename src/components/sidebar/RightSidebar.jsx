import { Bell, Calendar, Video, BellOff, FileIcon, ImageIcon, LinkIcon, X } from "lucide-react";
...
export default function RightSidebar({
    ...
    return (
        <div className={`transition-all duration-300 ease-in-out overflow-hidden z-20 shrink-0 ${isOpen ? "w-[300px] opacity-100" : "w-0 opacity-0 pointer-events-none"
            }`}>
            <div className="w-[300px] h-full bg-[var(--bg-primary)] rounded-[20px] p-5 flex flex-col shadow-sm border border-[var(--border-primary)] overflow-y-auto custom-scrollbar">

                <div className="flex items-center justify-between mb-5">
                    <h2 className="text-base font-bold text-[var(--text-primary)]">Chat Details</h2>
                    <button
                        onClick={onClose}
